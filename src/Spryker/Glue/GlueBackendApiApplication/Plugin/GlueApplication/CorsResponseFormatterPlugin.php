 ...
 */
class CorsResponseFormatterPlugin extends AbstractPlugin implements ResponseFormatterPluginInterface
{
    /**
     * {@inheritDoc}
     * - Adds CORS headers to the GlueResponseTransfer for cross-origin requests.
     *
     * @api
     *
    ...
    public function format(GlueResponseTransfer $glueResponseTransfer, GlueRequestTransfer $glueRequestTransfer): GlueResponseTransfer
    {
        ...
        $glueResponseTransfer->setMeta(array_merge($glueResponseTransfer->getMeta(), $corsHeaders));
